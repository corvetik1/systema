...
import { Account, Transaction, Debt, Loan } from './financeSlice';
 ...
 * @throws {string} Сообщение об ошибке при неудачном удалении.
 */
export const deleteTransaction = createAsyncThunk<{ id: number }, number>(
 ...
 * @throws {string} Сообщение об ошибке при неудачной загрузке.
 */
export const fetchDebts = createAsyncThunk<Debt[], void>(
  'finance/fetchDebts',
  async (_, { dispatch, rejectWithValue }) => {
    try {
 ...
 * @throws {string} Сообщение об ошибке при неудачной загрузке.
 */
export const fetchLoans = createAsyncThunk<Loan[], void>(
  'finance/fetchLoans',
  async (_, { dispatch, rejectWithValue }) => {
    try {
 ...
 * @throws {string} Сообщение об ошибке при неудачном добавлении.
 */
export const addDebitCard = createAsyncThunk<Account, { name: string; user_id: number }>(
 ...
 */
export const saveCreditCard = createAsyncThunk<Account, { accountId: number; creditCardData: Account }>(
 ...
 * @throws {string} Сообщение об ошибке при неудачном сохранении.
 */
export const saveEditedLoan = createAsyncThunk<Loan, { loanId: number; loanData: Loan }>(
